...
public class ImageFragment extends Fragment {
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
    ...
    binding.showDetails.setOnClickListener((v) -> Navigation.findNavController(binding.getRoot())
        .navigate(ImageFragmentDirections.showDetails(apodId)));
  ...
  private void handleApod(Apod apod) {
    String title = apod.getTitle().strip();
  ...
  private class ImageCallback implements Callback {
    ...
    public void onError(Exception e) {
      Snackbar.make(binding.getRoot(), R.string.image_load_error_message, Snackbar.LENGTH_LONG)
          .show();
    }
